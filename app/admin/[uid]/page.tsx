...
export default function AdminDashboard() {
  ...
  // latest lists
  const [latestProducts, setLatestProducts] = useState<(Product & { id: string })[]>([])
  const [latestFoods, setLatestFoods] = useState<(Food & { id: string })[]>([])
  const [userActivities, setUserActivities] = useState<(UserProfile & { id: string })[]>([])
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(qy, (snap) => {
      setLatestFoods(
        snap.docs.map((d) => ({ id: d.id, ...(d.data() as Food) }))
      )
    })
    return () => unsub()
  }, [foodsRef])
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                >
                  <span className={`mr-2 ${loadingTotals ? 'animate-spin' : ''}`}>
                    <FiRefreshCw />
                  </span>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className={`p-3 rounded-lg ${card.color} bg-opacity-10 ${card.textColor}`}>
                      <Icon size={24} />
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                <h2 className="text-lg font-semibold text-gray-900 flex items-center">
                  <span className="mr-2 text-blue-600"><FiPackage /></span>
                  Produk Terbaru
                </h2>
              </div>
                ...
                >
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden flex-shrink-0">
                    {p.images?.[0] ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <span className="text-gray-400"><FiPackage size={20} /></span>
                      </div>
                    )}
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 flex items-center mt-1">
                      <span className="mr-1"><FiCalendar size={12} /></span>
                      {fmtDate(p.createdAt)}
                      {p.category && (
                        <>
                  ...
                  <div className="text-sm font-semibold text-blue-600 flex items-center">
                    <span className="mr-1"><FiDollarSign size={14} /></span>
                    {fmtRp(p.price)}
                  </div>
                </motion.div>
              ))}
              {latestProducts.length === 0 && (
                <div className="p-6 text-center text-gray-500">
                  <div className="mx-auto text-gray-400 mb-2 w-fit"><FiPackage size={24} /></div>
                  <p>Belum ada produk</p>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                          <div className="p-6 border-b border-gray-100">
                            <h2 className="text-lg font-semibold text-gray-900 flex items-center">
                              <span className="mr-2 text-orange-600"><FiCoffee /></span>
                              Makanan Terbaru
                            </h2>
                          </div>
                          {latestFoods.map((f) => (
                            ...
                            >
                              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden flex-shrink-0">
                                {f.images?.[0] ? (
                                  ...
                                  <div className="w-full h-full flex items-center justify-center">
                                    <span className="text-gray-400"><FiCoffee size={20} /></span>
                                  </div>
                                )}
                              </div>
                              <div className="flex-1 min-w-0">
                          ...
                          {latestFoods.length === 0 && (
                            <div className="p-6 text-center text-gray-500">
                              <div className="mx-auto text-gray-400 mb-2 w-fit"><FiCoffee size={24} /></div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                          <div className="p-6 border-b border-gray-100">
                            <h2 className="text-lg font-semibold text-gray-900 flex items-center">
                              <span className="mr-2 text-purple-600"><FiActivity /></span>
                              Aktivitas User
                            </h2>
                          </div>
                            ...
                            >
                              ...
                              <div className="text-xs text-gray-500 space-y-1">
                                <div className="flex items-center">
                                  <span className="mr-1"><FiUser size={12} /></span>
                                  {u.email}
                                </div>
                                <div className="flex items-center">
                          ...
                          {userActivities.length === 0 && (
                            <div className="p-6 text-center text-gray-500">
                              <div className="mx-auto text-gray-400 mb-2 w-fit"><FiActivity size={24} /></div>
