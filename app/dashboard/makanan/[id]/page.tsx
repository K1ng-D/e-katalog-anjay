...
import { FiArrowLeft, FiShoppingCart, FiShare2, FiHeart, FiClock, FiBox, FiShoppingBag, FiMessageCircle, FiGlobe, FiCoffee } from 'react-icons/fi'
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {notFound ? (
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Makanan Tidak Ditemukan</h2>
              <p className="text-gray-600 mb-6">Maaf, makanan yang Anda cari tidak ditemukan dalam katalog.</p>
              <Link
                href="/makanan"
              ...
              >
                ...
                {item.status && (
                  <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                    ...
                    <div className={`w-2 h-2 rounded-full mr-2 ${
                      ...
                      item.status === 'soldout' ? 'bg-red-500' :
                      'bg-gray-500'
                    }`}></div>
                    {item.status === 'available' ? 'Tersedia' : 
                     item.status === 'soldout' ? 'Habis' : 'Draft'}
                  </div>
                )}
                ...
                {(item.links?.whatsapp || item.links?.shopee || item.links?.tokopedia || item.links?.website) && (
                  <div className="pt-6 border-t border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Pesan melalui:</h3>
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                      {item.links?.whatsapp && (
                        ...
                        >
                          <div className="mb-2"><FiMessageCircle size={24} /></div>
                      ...
                      {item.links?.shopee && (
                        ...
                        >
                          <div className="mb-2"><FiShoppingBag size={24} /></div>
                      ...
                      {item.links?.website && (
                        ...
                        >
                          <div className="mb-2"><FiGlobe size={24} /></div>
